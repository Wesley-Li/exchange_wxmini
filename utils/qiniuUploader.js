(function () {
    ...
    async function upload(filePath, success, fail, options, progress, cancelTask) {
        if (null == filePath) {
        ...
        if (config.qiniuUploadToken) {
            await doUpload(filePath, success, fail, options, progress, cancelTask);
        } else if (config.qiniuUploadTokenURL) {
            getQiniuToken(async function () {
                await doUpload(filePath, success, fail, options, progress, cancelTask);
            });
            ...
            success: function (res) {
                ...
                try {
                    if(typeof(dataString)=="string"){
                        ...
                        var dataObject = dataString;
                    }
                    // 拼接fileURL
                    var fileURL = config.qiniuBucketURLPrefix?config.qiniuBucketURLPrefix + '/' + dataObject.key:dataObject.key;
